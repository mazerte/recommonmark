...
class AutoStructify(transforms.Transform):
    ...
    def auto_toc_tree(self, node):
        ...
        for nd in node.children[:]:
            ...
            elif isinstance(ref, sphinx.addnodes.pending_xref):
                #<pending_xref refdomain="True" refexplicit="False" refname="summary" reftarget="pages/summary" reftype="any" refwarn="True">Summary</pending_xref>
                label = "" + ref.children[0]
                refs.append((label, ref['reftarget']))
            else:
                return None
        ...
        return self.state_machine.run_directive(
            'toctree',
            options={'maxdepth': 1, 'numbered': numbered, 'titlesonly': True},
